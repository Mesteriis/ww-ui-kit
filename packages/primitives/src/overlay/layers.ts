...
function readNumberVariable(root: HTMLElement, variableName: string, fallback: number): number {
...
export function readOverlayLayerScale(root?: HTMLElement | null): OverlayLayerScale {
  ...
  return {
    base: readNumberVariable(resolvedRoot, OVERLAY_LAYER_VARIABLES.base, DEFAULT_LAYER_SCALE.base),
    step: readNumberVariable(resolvedRoot, OVERLAY_LAYER_VARIABLES.step, DEFAULT_LAYER_SCALE.step),
