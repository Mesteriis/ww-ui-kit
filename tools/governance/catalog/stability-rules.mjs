...
export const STABILITY_DESCRIPTIONS = Object.freeze({
  stable: 'Public and intentionally supported. Changes require tests, docs, and semver honesty.',
  incubating:
  ...
  internal: 'Not part of the supported consumer surface. Internal-only tooling or app scaffolding.',
});
