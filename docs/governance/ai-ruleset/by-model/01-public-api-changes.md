...
- Decide whether each changed public visual surface is lab-eligible and update the playground lab manifest.
...
- Do not leave manifest, lab coverage, stories, or docs stale.
