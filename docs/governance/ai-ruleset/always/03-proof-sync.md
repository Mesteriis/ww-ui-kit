...
- Add or update troubleshooting guidance when repository tooling, CI expectations, or recurring contributor failures change.
- Add or update playground scenarios when a public surface requires real composition proof.
- Add or update playground lab schemas, preview runtime, and usage data when a lab-eligible visual surface changes.
...
- Do not add ad hoc playground demos outside the governed lab or testing harness structure.
