...
defineOptions({ name: 'CoreAdvancedStoryHarness' });

type UiDateRangeValue = [string | null, string | null];
type UiCalendarValue = string | UiDateRangeValue | null;
...
const rangeValue = ref<UiDateRangeValue>(['2026-04-04', '2026-04-08']);
const calendarValue = ref<UiCalendarValue>('2026-04-04');
  ...
  <div class="ui-stack" style="display: grid; gap: var(--ui-space-5);">
    <UiCard>
      ...
      <div style="display: grid; gap: var(--ui-space-4);">
        ...
        <UiWatermark content="Belovodye contract" :rotate="props.mode === 'theming' ? -18 : -26">
          <UiCard>
    ...
    >
      ...
      <UiCard>
        ...
        <UiImagePreviewGroup :items="imageItems" :columns="props.mode === 'states' ? 2 : 3" />
      </UiCard>
    </div>

    <UiCard>
      <template #header>Splitter</template>
      <UiSplitter :initial-ratio="props.mode === 'states' ? 65 : 50">
        <template #first>
    ...
    >
      <UiCard>
        ...
        <div style="display: grid; gap: var(--ui-space-3);">
          ...
          <UiCalendar v-model="calendarValue" :mode="props.mode === 'states' ? 'range' : 'single'" />
        </div>
      </UiCard>
